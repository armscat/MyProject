...
import com.armscat.photoeditors.loader.ImageLoader;
import com.armscat.photoeditors.util.ProviderUtil;
...
public class ImagePicker {
    ...
    public static final String EXTRA_FROM_DEL = "isShowDel";

    private boolean multiMode = true;    //图片选择模式
    private int selectLimit = 16;         //最大选择图片数量
    private boolean crop = true;         //裁剪
    private boolean isOrigin = false;         //是否为原图
...
//                takeImageFile = new File(Environment.getExternalStorageDirectory(), "/DCIM/camera/");
                takeImageFile = new File(Environment.getExternalStorageDirectory(), UUID.randomUUID().toString() + ".jpg");
            } else {
